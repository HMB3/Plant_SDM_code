...
png(sprintf('output/figures/SUA_percent/SUA_BAR_PLOT_SUM_100_%s_%s_%s_%s.png', SUA_SPP, 2030, 'temp', SUAs ),      
...
png(sprintf('output/figures/SUA_percent/SUA_BAR_PLOT_SUM_100_%s_%s_%s_%s.png', SUA_SPP, 2070, 'temp', SUAs ),      
    10, 8, units = 'in', res = 500)
...
png(sprintf('output/figures/SUA_percent/SUA_BAR_PLOT_SUM_100_%s_%s_%s_%s.png', SUA_SPP, 2030, 'area', SUAs ),      
    10, 8, units = 'in', res = 500)
...
png(sprintf('output/figures/SUA_percent/CAPITAL_SUA_BAR_PLOT_SUM_100_%s_%s_%s_%s.png', SUA_SPP, 2030, 'temp', SUAs ),      
    10, 8, units = 'in', res = 500)
...
png(sprintf('output/figures/SUA_percent/CAPITAL_SUA_BAR_PLOT_SUM_100_%s_%s_%s.png', 2070, 'temp', '200km2'),      
    10, 8, units = 'in', res = 500)
...
#########################################################################################################################
## Create PNG output for Major captuials, 2070
png(sprintf('output/figures/SUA_percent/CAPITAL_SUA_BAR_PLOT_SUM_100_%s_%s_%s.png', 2070, 'area', '200km2'),      
    10, 8, units = 'in', res = 500)
...
SUA.LOSS.2070                = SUA.LOSS.2070[c("SPECIES_LOSS", "CURRENT_MAT")]


#########################################################################################################################
## Run GAMs of species gains vs MAT for 2070
...
CairoPNG(width = 13000, height = 10000, 
         file = sprintf('output/figures/SUA_percent/SUA_2070_SPP_GAIN_vs_MAT_GAM_%s_%s.png', SUA_SPP, SUAs ),
...
CairoPNG(width = 13000, height = 10000, 
         file = sprintf('output/figures/SUA_percent/SUA_2070_SPP_LOSS_vs_MAT_GAM_%s_%s.png', SUA_SPP, SUAs ),
         canvas = "white", bg = "white", units = "px", dpi = 600)
