...
if (nrow(ALA.ALL) > 0) {
  ...
  message('No ALA dat for this taxon, creating empty datframe to bind to GBIF data')
  ALA.LAND  = setNames(data.frame(matrix(ncol = length(ALA.keep), nrow = 0)), ALA.keep)
