...
## This data was generated by Anna Ukola 
...
## This data was generated by Sarah Kirkpatric
...
#########################################################################################################################
## Extract AWAP/ANUCLIM drought and heatwave data
...
COMBO.ANUCLIM <- raster::extract(awap.heatwave, COMBO.POINTS)


## Bind the data together and check 
