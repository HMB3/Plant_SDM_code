  ...
  lapply(DIR_list, function(DIR) { 
    ...
    lapply(species_list, function(species) {
      ...
      for (thresh in thresholds) {
        ...
        ## Maybe ask John if this is a good idea?
        # if(file.exists(not_novel)) { 
        #   
        #   not_novel = raster(not_novel)
        #   combo_suit_4GCM <- combo_suit_4GCM * !is.na(not_novel) 
        #   plot(combo_suit_4GCM, main = paste0("4GCM * MESS for ", species))
        #   
        # } else {
        #   
        #   combo_suit_4GCM <- combo_suit_4GCM
        #   
        # }
