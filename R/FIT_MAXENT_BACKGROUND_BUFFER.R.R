...
fit_maxent2 <- function(occ, bg, predictors, name, outdir, template, max_bg_size=100000, 
                       shapefiles=TRUE, features, replicates, 
                       responsecurves=TRUE, rep_args, full_args) {
