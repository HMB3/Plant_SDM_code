...
for (species in plot.taxa[1:3]) {
  ...
  DF     <- subset(HIST.PLOT, searchTaxon == species)
  DF.OCC <- subset(HIST.PLOT, searchTaxon == species & SOURCE != "INVENTORY")
  DF.INV <- subset(HIST.PLOT, searchTaxon == species & SOURCE == "INVENTORY")
