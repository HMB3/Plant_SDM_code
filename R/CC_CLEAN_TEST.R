...
for (species in plot.taxa[1:2]) {
  ...
  png(sprintf("./data/ANALYSIS/CLEAN_GBIF/CHECK/%s_%s", species, "global_check_CC.png"),
      16, 10, units = 'in', res = 500)
  
  par(mfrow = c(1,2))
  plot(LAND.84, main = paste0("Global clean_coord points for ", species),
  ...
  ## Black == FALSE
  ## Red   == TRUE
  plot(AUS.84, main = paste0("Australian clean_coord points for ", species),
...
for (species in plot.taxa) {
  ...
  ## Red   == TRUE
  message('Writing map of global coord clean records for ', species)
  png(sprintf("./data/ANALYSIS/CLEAN_GBIF/CHECK/%s_%s", species, "global_check_cc_out.png"),
      16, 10, units = 'in', res = 500)
  
  par(mfrow = c(1,2))
  plot(LAND.84, main = paste0("Global cc_out points for ", species),
       lwd = 0.01, asp = 1, col = 'grey', bg = 'sky blue')
  ...
  ## Black == FALSE
  ## Red   == TRUE
  plot(AUS.84, main = paste0("Australian cc_out points for ", species),
       lwd = 0.01, asp = 1, bg = 'sky blue', col = 'grey')
