...
png(sprintf('output/figures/SUA_percent/ALL_SUA_SUA_BAR_PLOT_PRESENT_%s_%s.png', 2030, 'temp'),      
...
png(sprintf('output/figures/SUA_percent/ALL_SUA_SUA_BAR_PLOT_PRESENT_%s_%s.png', 2070, 'temp'),      
    10, 8, units = 'in', res = 500)
...
png(sprintf('output/figures/SUA_percent/ALL_SUA_SUA_BAR_PLOT_PRESENT_%s_%s.png', 2070, 'area'),      
    10, 8, units = 'in', res = 500)
...
png(sprintf('output/figures/SUA_percent/CAPITAL_SUA_SUA_BAR_PLOT_PRESENT_%s_%s.png', 2030, 'temp'),      
    10, 8, units = 'in', res = 500)
...
png(sprintf('output/figures/SUA_percent/CAPITAL_SUA_SUA_BAR_PLOT_PRESENT_%s_%s.png', 2070, 'temp'),      
    10, 8, units = 'in', res = 500)
...
#########################################################################################################################
## Create PNG output for Major capitals, 2070
png(sprintf('output/figures/SUA_percent/CAPITAL_SUA_SUA_BAR_PLOT_PRESENT_%s_%s.png', 2070, 'area'),      
    10, 8, units = 'in', res = 500)
