...
save_run      = "SUA_RMD"                       ## A variable to append the run name to the output files
...
under the future scenarios (2030, 2050 and 2070). This was achieved by creating a third function, that 
counts cells lost or gained within an SUA (i.e. looping over each species and threshold, for each 
time period, E.G. 2030)
